...
def _extract_operators_and_operands(source_code: str) -> dict:
    ...
    halstead_metrics_logger.info("[_extract_operators_and_operands] starting extraction")
    """_summary_
    ...
    halstead_metrics_logger.info("[_extract_operators_and_operands] Finished extraction. Operators: %d, Operands: %d",
                                 len(grouped['total_operators']), len(grouped['total_operands']))
    return grouped
...
def _calculate_halstead_metrics(info_dict: dict) -> dict:
  ...
  halstead_metrics_logger.info("[_calculate_halstead_metrics] Completed. Volume: %.3f, Difficulty: %.3f, Effort: %.3f",
                                 halstead_metrics["V"], halstead_metrics["D"], halstead_metrics["E"])
