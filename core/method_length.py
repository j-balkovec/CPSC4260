...
def _find_long_method(source_code: str) -> list:
    ...
    for method in long_methods:
        long_method_logger.info(f"Method '{method['function']}' from line {method['start_line']} to {method['end_line']} is {method['length']} lines long (threshold: {method['threshold']}).")
